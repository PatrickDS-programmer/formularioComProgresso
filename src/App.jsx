...
function App() {
  const [data, setData] = useState({
   ...
   const calculateProgress = () =>{
    ...
    if(data.fullName){
      const splitString = data.fullName.split(' ')
      if(splitString[1]){
        value += amount
      }
    }
      ...
      <main>
        ...
        <div className='form-group'>
          ...
          <div className='radios-container'>
            <span>
              <input type='radio' name="gender" value="masculino" onChange={handleChange} checked={data.gender === 'masculino'}/> Masculino
            </span>
            <span>
              <input type='radio' name="gender" value="feminino" onChange={handleChange} checked={data.gender === 'feminino'}/> Feminino
            </span>
          </div>
        </div>
